...
public class ColorPickerTriangle : MonoBehaviour
{
    ...
    public MousePainter mousePainter; // Додано MousePainter для інтеграції
    ...
    public void SetNewColor(Color NewColor)
    {
        ...
        mousePainter.paintColor = TheColor; // Встановлення обраного кольору в MousePainter
    }
    ...
    private void SetColor()
    {
        ...
        TheColor = c;
        TheColor.a = 1f;
        mousePainter.paintColor = TheColor; // Оновлення кольору в MousePainter
    }
